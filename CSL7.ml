...
(* 10.9 *)
(* 目的：２つのリストを受け取ったら、それらの長さは同じかどうかを判定する *)
(* equal_length : list -> list -> Bool *)
...
let test5 = equal_length ["a"; "b";] [1; 2; 3] = false
let test6 = equal_length ["a"; "b";] ["a"; "b"; "c"] = false
let test7 = equal_length ["a"; "b"; "c"] [1; 2; 3] = true;;


(* ポイント：再帰のゴールはリストが空になるまでを考える！ *)
...
(* テスト *)
let test1 = sum_of_square 4 = 30;;(* 0^2 + 1^2 + + 2^2 + 3^2 + 4^2 *)
